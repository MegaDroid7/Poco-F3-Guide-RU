...
* Удаление раздела "Камера" из-за ненужности (во многих прошивках ставят [MIUI камеру от johnmart19](https://gitlab.com/johnmart19/vendor\_xiaomi\_camera) или похожую)
* Удаление гайда на Pixel Experience и VoidUI по причине [EOL](https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D0%B4%D1%83%D0%BA%D1%82\_%D1%81\_%D0%B8%D1%81%D1%82%D1%91%D0%BA%D1%88%D0%B8%D0%BC\_%D1%81%D1%80%D0%BE%D0%BA%D0%BE%D0%BC\_%D1%81%D0%BB%D1%83%D0%B6%D0%B1%D1%8B).
* Добавление гайда [pixelos.md](roms/pixelos.md "mention")
* Исправление гайда по разблокировке загрузчика (добавлен пункт про Mi Community)
* Удаление способа разблокировки загрузчика через Linux (используйте ВМ и проброс USB).
* Обновление стилистики изменений. Теперь можно удобно перейти к нужной дате истории изменений.
* Добавление способа восстановления TEE.
* Исправление ссылок в [xiaomi.eu.md](ROMs/xiaomi.eu.md "mention") на HyperOS 1.0
* Добавление порта HyperArt
* Добавление порта OxygenOS 14.1 (последний, на мое мнение стабильный порт)
* Добавление пункта установки драйверов и ADB в базу
* Убрано из "гайда по прошивке" пункт с установкой рекавери. Обычно с каждой прошивкой поставляется своё рекавери, нет смысла устанавливать поверх этого рекавери своё.
* Добавление прощального письма.
...
* Добавление заметки и записи об окончании жизни прошивки VoidUI [Broken link](broken-reference "mention")
...
* Обновление гайда [Broken link](broken-reference "mention") (актуализация информации)
...
* Замена ссылки vendor\_boot для [Broken link](broken-reference "mention") с версии A12 на версию A13

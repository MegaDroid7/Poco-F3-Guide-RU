...
7. Запустите консоль в папке с adb. Это можно сделать просто: нажмите на пустое место в строке с путём файла и введите "cmd". После чего, нажмите Enter.![](<../.gitbook/assets/image (6) (1).png>)![](<../.gitbook/assets/image (3) (1).png>)
...
13. Установите рекомендуемое мейнтейнером (сборщиком прошивки) Firmware, если таковое имеется.
14. Установите прошивку
15. **Перезапустите устройство в Recovery**
16. Сделайте формат Data через yes
17. Перезапустите телефон
{% endtab %}

...
* [🤖 Firmware](beginning/firmware.md)
...
* [⏩ Универсальный гайд по установке кастомных ядер](kernels/universal-guide-kernel.md)
* [🌌 No Gravity Kernel](kernels/no-gravity-kernel.md)
* [❌ Immensity-X](kernels/Immensity-X.md)
* [🦁 RealKing](kernels/realking.md)
...
* [Too many links / Error reading sparse file](problem-fix/too-many-links-error-reading-sparse-file.md)
* [(recovery\_a) no such partition](problem-fix/recovery\_a-no-such-partition.md)
* [Видео на YouTube в 24 FPS](problem-fix/youtube-24fps-fix.md)
